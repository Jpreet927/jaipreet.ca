...
const BusinessCard = () => {
    ...
    return (
        <div
            className="flex flex-col justify-between h-[40%] sm:min-h-[300px] sm:min-w-[450px] min-h-[250px] min-w-[400px] max-w-[700px] w-full lg:absolute static top-[30%] left-0 bg-black/50 xl:p-12 sm:p-8 p-6 backdrop-blur-xl border-slate-700/40 rounded-xl border duration-100 transform-none hover:bg-black/40 hover:scale-[0.97] ease-in-out transition"
