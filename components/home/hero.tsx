  ...
  return (
    <section className="h-screen w-screen overflow-hidden">
      ...
      >
        <div className="flex flex-col gap-4 sm:text-left text-center">
          ...
          >
            {"Hey, I'm Jaipreet".split("").map((char, index) => {
              return (
                <motion.span key={index} variants={textOpacityChar}>
                  {char}
                </motion.span>
              );
            })}
          ...
          <motion.div
            ...
            className="flex"
          >
            <p className="opacity-75 mr-1">I’m a software developer @</p>
            <Link
        ...
        >
          <p>
            Based in <br /> <span className="font-bold">Toronto, ON</span>
          </p>
