...
const ThankYou = () => {
    return (
        <section className="relative overflow-hidden w-screen h-screen bg-black flex justify-center items-center">
            <div className="z-10 xl:w-[50%] w-[75%] flex flex-col justify-center items-center gap-12">
                <h1
            ...
            <div className="absolute top-0 left-0 w-full h-full">
                <div className="absolute bottom-[-25%] left-[25%] w-[50%] aspect-square bg-gradient-1 blur-[10rem] rounded-full"></div>
                <div className="absolute bottom-0 left-[30%] w-[20%] aspect-square translate-y-[50%] bg-white opacity-50 blur-[10rem] rounded-full"></div>
                <div className="absolute bottom-0 left-[40%] w-[25%] aspect-square translate-x-[75%] translate-y-[50%] bg-gradient-1 blur-[10rem] rounded-full animate-gradient-pulse-2"></div>
            </div>
        </section>
    );
};
